...
func Signup() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<form hx-post=\"/auth/signup\" hx-trigger=\"submit\">Username: <input type=\"text\" name=\"username\" autocomplete=\"off\"> Email: <input type=\"email\" name=\"email\" autocomplete=\"off\"> Password: <input type=\"password\" name=\"password\" autocomplete=\"off\"> <button type=\"submit\">Sign Up</button></form>")
			if templ_7745c5c3_Err != nil {
